...
public class LifeProgressSprite extends FreeSprite {
	private int x;
	private int y;
	private Bitmap bmp;
	...
	public LifeProgressSprite(ConcurrentLinkedQueue<FreeSprite> sprites, GameView gameView, int x, int y, Bitmap bmp, Bitmap bmpHead) {
	...
	public void onDraw(Canvas canvas) {
		...
		percentage = gameView.getLifeProgressPercentage();
		int srcX = 0;
